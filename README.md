...
NOTE: This version is for MC 1.6.4, CC 1.58, and LanteaCraft RC1_37 and is no longer supported.
      ...
      In the mean time, 2.0 can be found here...
      .
      ...
      .
      gateBuddy is a set & forget replacement for gateLiaison only in instances where ccDialer will be used exclusivley (no support for ccDHD)
      ccDialer is for advanced portable computers - it requires either gateBuddy or a full ccDHD/gateLiaison installation
